    ...
    <div className='w-screen h-screen bg-cover bg-center bg-[url("/doctor.jpg")]'>
      <div className="flex flex-col  justify-center items-center h-screen">
        ...
        <Link to={"/doctor/signup"}>
          <button className="mt-2 relative flex w-32 h-10 rounded-3xl items-center justify-center overflow-hidden bg-teal-300 font-medium text-white shadow-2xl transition-all duration-300 before:absolute before:inset-0 before:border-0 before:border-white before:duration-100 before:ease-linear hover:bg-white hover:text-black hover:shadow-blue-600 hover:before:border-[25px]">
