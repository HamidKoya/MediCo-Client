...
function Footer() {
  return (
    <footer class="w-full b-gray-700 bg-gray-200 body-font">
      <div class="container flex flex-col flex-wrap px-8 py-20 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
